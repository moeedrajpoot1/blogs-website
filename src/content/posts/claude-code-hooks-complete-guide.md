...
- [Claude Code Skills complete guide](/posts/claude-code-skills-complete-guide/) for when you want reusable instructions Claude loads on demand, instead of a hook that runs on every event.
